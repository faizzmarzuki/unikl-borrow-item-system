...
<body>
  <div class="header">
    <h1><a href="adminmain.php" class="active"><img src="logo.png" alt="Girl in a jacket" width="200" height="100"></a></h1>
  </div>
  ...
  <?php  
  echo '<h2 class="promo__title">Welcome <span>'.$_SESSION['name'].'</span></h2>';
    ?>
    <p class="promo__descr">This is Admin's Homepage for IT Service Application Form</p>
