...
<div class = "item">
<p>Action Done</p>
<textarea rows="5" name="txtaction"></textarea>
</div>
</fieldset>
<fieldset>
<legend>Attend By</legend>
<p>Staff Name</p>
<input type="text" name="txtnameStaff" value="<?php echo $rec['Tech_staffname']; ?>">
<p>ID No</p>
<input type="text" name="txtidStaff" value="<?php echo $rec['Techstaff_id']; ?>">
<p>Date</p>
<input type="date" name="txtdateStaff" value="<?php echo $rec['Date']; ?>">
<p>Review</p>
<input type="text" name="txtreview" value="<?php echo $rec['Review']; ?>">
</div>
</div>
</fieldset>
<div class="btn-block">
