...
<body>
  <div class="header">
    <h1><a href="Main.html" class="active"><img src="logo.png" alt="Girl in a jacket" width="200" height="100"></a></h1>
  </div>
  ...
  <section class="promo js-jumbo" id="home">
    ...
    <p class="promo__descr">This is Homepage for IT Service Application Form</p><a class="promo__btn" href="#">Learn more</a><a
      class="promo__go-next js-anchor" href="#portfolio">Scroll down</a>
  ...
  <div class="column left" style="background-color:#f8be00;">
    ...
    <br><br>
    <a class="promo__btn" href="#">User Manual</a>
  </div>
