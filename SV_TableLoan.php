...
<div class="header">
    <center><h1><a href="svmain.php" class="active"><img src="logo.png" alt="Girl in a jacket" width="200" height="100"></a></h1></center>
  </div>
...
<body>
<br></br>
<h1><center>IT Equipment Loan Form</center></h1>
...
<?php
	if (isset($_POST["submit"])){
		...
		$sql = "SELECT * FROM `form_loan` WHERE Justify = '$searchs'";
		$result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
	}else {
		include("db.php");
		$sql = "SELECT * FROM `form_loan` ";
		$result = mysqli_query($conn,$sql) or die(mysqli_error($conn));
	}
	?>
	<?php
  ...
  <?php while($rec = mysqli_fetch_array($result,MYSQLI_BOTH))
	...
	?>
	<td></td>
	<td><a href="SV_ViewLoan.php?id=<?php echo $rec['id']; ?>">VIEW</a></td>
	...
	{
	?>
  	<td><a href="SV_UpdateLoan.php?id=<?php echo $rec['id']; ?>">EDIT</a></td>
	<td><a href="SV_ViewLoan.php?id=<?php echo $rec['id']; ?>">VIEW</a></td>
