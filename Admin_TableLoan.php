...
<?php
  ...
  <?php while($rec = mysqli_fetch_array($result,MYSQLI_BOTH))
	...
	?>
	<td></td>
	<td><a href="Admin_UpdateLoan.php?id=<?php echo $rec['id']; ?>">EDIT</a></td>
	<td><a href="Admin_ViewLoan.php?id=<?php echo $rec['id']; ?>">VIEW</a></td>
	...
	{
	?>
	<td><a href="Delete_Loan.php?id=<?php echo $rec['id']; ?>">DELETE</a></td>
  	<td><a href="Admin_UpdateLoan.php?id=<?php echo $rec['id']; ?>">EDIT</a></td>
	<td><a href="Admin_ViewLoan.php?id=<?php echo $rec['id']; ?>">VIEW</a></td>
	...
	?>
	<td></td>
	<td><a href="Admin_UpdateLoan.php?id=<?php echo $rec['id']; ?>">CLOSED</a></td>
	<td><a href="Admin_ViewLoan.php?id=<?php echo $rec['id']; ?>">VIEW</a></td>
